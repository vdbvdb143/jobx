  ...
  <body>
    <div class="left">
      <button class=" btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
       ...
       <div class="heading">
        <h5>Job Recruiter Login</h5>
      </div>
      </div>
      
      <div class="container">
     
    <form:form method="post" modelAttribute="companyLogin" action="/companyLoginVerify">
    	
        <div class="form-group">
          <label for="exampleInputEmail1">Email address</label>
          <form:input type="email" class="form-control"  placeholder="Enter email" path="com_email" required="required"/>
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Password</label>
          <form:input type="password" class="form-control" path="password" required="required" placeholder="Password"/>
        </div>
        <h6 class="below"><a href="/com_register">didn't have an account?</a></h6>
